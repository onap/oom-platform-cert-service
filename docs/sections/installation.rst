...
Setting this flag, will also cause CertService to load test configuration from *kubernetes/oom/components/oom-cert-service/resources/test/cmpServers.json*
