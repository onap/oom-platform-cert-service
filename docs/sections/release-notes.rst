...
- `OOM-2560 <https://jira.onap.org/browse/OOM-2560>`_ Integrated CertService's external provider with OOM
  ...
  During ONAP deployment external provider is enabled when flags cmpv2Enabled, CMPv2CertManagerIntegration and platform.enabled are equals to true.
