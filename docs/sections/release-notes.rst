...
- `OOM-2560 <https://jira.onap.org/browse/OOM-2560>`_ Integrated CMPv2 external provider with OOM

  An CMPv2 external provider is a part of PKI infrastructure. It consumes CertificateRequest CRD from Cert-Manager and calls CertService API to enroll certificate from CMPv2 server.
  During ONAP deployment external provider is enabled when flags cmpv2Enabled, CMPv2CertManagerIntegration and platform.enabled equals true.
...
- :doc:`CMPv2 external provider description <cmpv2-cert-provider>`
