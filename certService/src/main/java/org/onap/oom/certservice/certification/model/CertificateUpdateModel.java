...
public final class CertificateUpdateModel {
    ...
    public static class CertificateUpdateDataBuilder {
        ...
        public CertificateUpdateDataBuilder setEncodedCsr(String encodedCsr) {
            this.encodedCsr = encodedCsr;
            return this;
        }

        public CertificateUpdateDataBuilder setEncodedPrivateKey(String encodedPrivateKey) {
            this.encodedPrivateKey = encodedPrivateKey;
            return this;
        }

        public CertificateUpdateDataBuilder setEncodedOldCert(String encodedOldCert) {
            this.encodedOldCert = encodedOldCert;
            return this;
        }

        public CertificateUpdateDataBuilder setEncodedOldPrivateKey(String encodedOldPrivateKey) {
            this.encodedOldPrivateKey = encodedOldPrivateKey;
            return this;
        }

        public CertificateUpdateDataBuilder setCaName(String caName) {
            this.caName = caName;
            return this;
        }
