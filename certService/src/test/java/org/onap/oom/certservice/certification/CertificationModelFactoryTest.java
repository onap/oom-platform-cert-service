...
class CertificationModelFactoryTest {
    ...
    void shouldCreateProperCertificationModelWhenGivenProperCsrModelAndCaName()
        ...
        CertificationResponseModel certificationModel =
            certificationModelFactory.provideCertificationModelFromInitialRequest(ENCODED_CSR, ENCODED_PK, TEST_CA_NAME);
    ...
    void shouldThrowDecryptionExceptionWhenGivenWrongEncodedCsr()
        ...
        Exception exception = assertThrows(
            DecryptionException.class, () ->
                certificationModelFactory.provideCertificationModelFromInitialRequest(ENCODED_WRONG_CSR, ENCODED_WRONG_PK, TEST_CA_NAME)
        );
    ...
    void shouldPerformKurWhenCsrAndOldCertDataMatch()
        ...
        // When
        CertificationResponseModel certificationModel = certificationModelFactory
    ...
    void shouldThrowCmpClientExceptionWhenUpdateRequestFailed()
        ...
        Exception exception = assertThrows(
            CmpClientException.class, () ->
                certificationModelFactory.provideCertificationModelFromUpdateRequest(TEST_CERTIFICATE_UPDATE_MODEL)
        );
