...
public class ExitableKeystoreInstance {
    ...
    public List<CertificateWithAlias> getTruststoreCertificates(File file, String password) throws ExitableException {
    ...
    public void addCertificates(List<CertificateWithAlias> certificatesWithAliases, File file, String password)
