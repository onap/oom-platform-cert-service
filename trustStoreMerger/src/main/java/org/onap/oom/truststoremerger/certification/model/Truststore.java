...
public class Truststore {
    ...
    private final TruststoreEntity truststoreEntity;

    public Truststore(TruststoreEntity truststoreEntity) {
        this.truststoreEntity = truststoreEntity;
    }

    public List<CertificateWithAlias> getCertificates() throws ExitableException {
        LOGGER.debug("Attempt to read certificates from file: {}", truststoreEntity.getStoreFile().getPath());
        return truststoreEntity.getNotEmptyCertificateList();
    }
    ...
    public void addCertificate(List<CertificateWithAlias> certificates) throws ExitableException {
        ...
        truststoreEntity.addCertificates(certificates);
    }

    public void saveFile() throws ExitableException {
        LOGGER.debug("Attempt to save file: {}", truststoreEntity.getStoreFile().getPath());
        truststoreEntity.saveFile();
    }

    public void createBackup() throws CreateBackupException {
        truststoreEntity.createBackup();
    }

    File getStoreFile() {
        return truststoreEntity.getStoreFile();
    }
}
