...
public class MergerConfigurationProvider {
    ...
    public MergerConfiguration createConfiguration()
        ...
        areSizesOfListsSame(truststoresPaths, truststoresPasswordsPaths, TRUSTSTORES_PATHS_ENV,
            TRUSTSTORES_PASSWORDS_PATHS_ENV);
        areSizesOfListsSame(sourceKeystorePaths, destinationKeystorePaths, KEYSTORE_SOURCE_PATHS_ENV,
    ...
    private void areSizesOfListsSame(List<String> firstList, List<String> secondList, String firstListEnvName,
