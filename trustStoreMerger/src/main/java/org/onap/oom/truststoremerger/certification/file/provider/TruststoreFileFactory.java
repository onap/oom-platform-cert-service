...
public class TruststoreFileFactory {
    ...
    private TruststoreFile createTypedTruststore(File truststoreFile, String truststorePasswordPath) throws PasswordReaderException, TruststoreFileFactoryException {
