...
public abstract class TruststoreProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(TruststoreProcessor.class);
    private static final String BACKUP_EXTENSION = ".bak";

    private final File storeFile;

    TruststoreProcessor(File storeFile) {
