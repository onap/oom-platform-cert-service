...
public class JavaCertificateControllerFactory {
    ...
    public static CertificateController create(File certFile, String certPassword, String keystoreType)
        ...
        try {
            JavaCertificateController javaCertificateController = new JavaCertificateController(
                KeyStore.getInstance(keystoreType), certFile, certPassword);
