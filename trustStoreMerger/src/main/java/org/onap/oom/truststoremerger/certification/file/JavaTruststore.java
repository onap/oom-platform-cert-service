...
public class JavaTruststore extends TruststoreFile {
    ...
    public JavaTruststore(File truststoreFile, String password, CertificateStoreController storeController) {
