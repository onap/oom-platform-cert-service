...
public class JavaTruststoreProcessorFactory {

    private static final Logger LOGGER = LoggerFactory.getLogger(JavaTruststoreProcessorFactory.class);

    private JavaTruststoreProcessorFactory() {
    }

    public static TruststoreProcessor create(File certFile, String certPassword, String instanceType)
        throws LoadTruststoreException, KeystoreInstanceException {
        try {
            JavaTruststoreProcessor javaCertificateController = new JavaTruststoreProcessor(
