...
public enum ExitStatus {
    ...
    TRUSTSTORE_LOAD_FILE_EXCEPTION(6, "Cannot load truststore file"),
    TRUSTSTORE_DATA_OPERATION_EXCEPTION(7, "Cannot operate on truststore data"),
    MISSING_TRUSTSTORE_EXCEPTION(8, "Missing truststore certificates in provided file"),
    ALIAS_CONFLICT_EXCEPTION(9, "Alias conflict detected"),
    WRITE_TRUSTSTORE_FILE_EXCEPTION(10, "Cannot save truststore file");
