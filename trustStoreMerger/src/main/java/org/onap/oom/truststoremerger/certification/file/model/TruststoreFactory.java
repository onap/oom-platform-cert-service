...
import org.onap.oom.truststoremerger.certification.file.provider.JavaCertificateManipulatorFactory;
...
public class TruststoreFactory {
    ...
    private Truststore createJavaTruststore(File truststoreFile, String truststorePasswordPath, String keystoreType)
        ...
        return new Truststore(truststoreFile, javaCertManipulator);
    }
