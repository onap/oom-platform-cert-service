...
public class PemTruststore extends TruststoreFile {
    ...
    private boolean pemFileIsEmpty() throws TruststoreDataOperationException {
        List<Certificate> certificateList = extractCertificatesFromFile(this.getTruststoreFile());
