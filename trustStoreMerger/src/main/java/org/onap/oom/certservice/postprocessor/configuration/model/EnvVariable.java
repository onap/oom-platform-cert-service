...
public enum EnvVariable {
    TRUSTSTORES_PATHS(true, ValidationFunctions.doesItContainValidCertificatesPaths()),
    TRUSTSTORES_PASSWORDS_PATHS(true, ValidationFunctions.doesItContainValidPasswordPaths()),
    KEYSTORE_SOURCE_PATHS(false, ValidationFunctions.doesItContainValidPathsToCopy()),
    KEYSTORE_DESTINATION_PATHS(false, ValidationFunctions.doesItContainValidPathsToCopy());
