...
class ValidationFunctionsTest {
    ...
    void shouldValidateWithSuccessCorrectCertificatesPaths() {
        ...
        // when
        boolean result = ValidationFunctions.doesItContainValidCertificatesPaths().test(certPaths);
        // then
    ...
    void shouldValidateWithSuccessCertificatesPasswordPaths() {
        ...
        // when
        boolean result = ValidationFunctions.doesItContainValidPasswordPaths().test(passwordPaths);
        // then
        assertThat(result).isTrue();
    }
