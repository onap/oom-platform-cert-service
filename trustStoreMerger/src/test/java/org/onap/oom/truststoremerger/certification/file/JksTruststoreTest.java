...
class JksTruststoreTest {
    ...
    void jksTruststoreShouldAddDifferentCertificates() throws Exception {
        ...
        List<CertificateWithAlias> p12certificates = CertificatesTestFileManager.getSampleP12Truststore()
            .getCertificates();
        List<CertificateWithAlias> pemCertificates = CertificatesTestFileManager.getSamplePemTruststoreFile()
            .getCertificates();
