...
import static org.onap.oom.truststoremerger.certification.file.CertificatesTestFileManager.*;
...
class ExitableKeystoreInstanceTest {
    ...
    void throwExceptionWhenAliasConflictDetected() throws Exception {
        ...
        List<CertificateWrapper> jksTruststoreCertificates = getSampleJksTruststoreFile().getCertificates();
