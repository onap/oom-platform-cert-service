...
import org.onap.oom.truststoremerger.certification.model.JavaTruststore;
...
class TruststoreFilesListProviderTest {
    ...
    void setUp()
        ...
        when(truststoreFactory.create(Mockito.endsWith(PEM_EXTENSION), Mockito.any()))
            .thenReturn(new PemTruststore(null));
        when(truststoreFactory.create(Mockito.endsWith(JKS_EXTENSION), Mockito.any()))
            .thenReturn(new JavaTruststore(null, null, null));
        when(truststoreFactory.create(Mockito.endsWith(P12_EXTENSION), Mockito.any()))
            .thenReturn(new JavaTruststore(null, null, null));
    }
    ...
    void shouldReturnTruststoreFilesList()
        ...
        List<Truststore> truststoreFilesList = truststoreFilesListProvider
            .getTruststoreList(truststorePaths, truststorePasswordPaths);
