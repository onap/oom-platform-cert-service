...
class TruststoreFilesListProviderTest {
    ...
    private void assertCorrectJksTruststore(Truststore truststore, String truststorePath, String truststorePass) {
        assertCorrectTypeAndTruststorePath(truststore, truststorePath, JavaTruststore.class);
        assertContainsCorrectPassword(truststore, truststorePass);
    }

    private void assertCorrectP12Truststore(Truststore truststore, String truststorePath, String truststorePass) {
        assertCorrectTypeAndTruststorePath(truststore, truststorePath, JavaTruststore.class);
        assertContainsCorrectPassword(truststore, truststorePass);
    }
    ...
    private void assertContainsCorrectPassword(Truststore truststore, String truststorePass) {
        JavaTruststore javaTruststore = (JavaTruststore) truststore;
