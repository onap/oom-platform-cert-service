...
class CertSaveLoadTest {
    ...
    void keystoreOpenTest() throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {
        ...
        ks.load(new FileInputStream("/home/twrobel/ONAP/research/oom-certservice/empty/trust1.jks"), "secret".toCharArray());
        System.out.println(Collections.list(ks.aliases()));

        Certificate certificate = ks.getCertificate("jks-alias");
        System.out.println();
        KeyStore ks2 = KeyStore.getInstance("JKS");
        ks2.load(new FileInputStream("/home/twrobel/ONAP/research/oom-certservice/empty/trust2.jks"), "secret".toCharArray());
...
//        ks.getCertificateChain()
        System.out.println();
        KeyStore ks2 = KeyStore.getInstance("JKS");
        ks2.load(new FileInputStream("/home/twrobel/ONAP/research/oom-certservice/empty/trust2_merged.jks"), "secret".toCharArray());
        System.out.println(Collections.list(ks2.aliases()));
    ...
    void loadPkcs12() throws IOException, CertificateException, NoSuchAlgorithmException, KeyStoreException {
        ...
        ks.load(new FileInputStream("/home/twrobel/ONAP/research/oom-certservice/empty/keystore.pkcs12"), "secret".toCharArray());
        System.out.println(Collections.list(ks.aliases()));
