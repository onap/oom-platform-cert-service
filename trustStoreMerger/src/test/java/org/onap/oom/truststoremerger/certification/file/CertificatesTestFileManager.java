...
public class CertificatesTestFileManager {
    ...
    public static P12Truststore createTmpP12TruststoreFile() throws IOException {
        Files.copy(Paths.get(SAMPLE_P12_TRUSTSTORE_FILE_PATH), Paths.get(TMP_P12_TRUSTSTORE_FILE_PATH),
    ...
    public static PemTruststore createEmptyTmpPemTruststoreFile() throws IOException {
        Files.copy(Paths.get(EMPTY_PEM_TRUSTSTORE_FILE_PATH), Paths.get(TMP_PEM_TRUSTSTORE_FILE_PATH),
            StandardCopyOption.REPLACE_EXISTING);
    ...
    public static JksTruststore createTmpJksTruststoreFileWithUniqAlias() throws IOException {
        Files.copy(Paths.get(SAMPLE_JKS_TRUSTSTORE_UNIQUE_ALIAS_FILE_PATH), Paths.get(TMP_JKS_TRUSTSTORE_FILE_PATH),
            StandardCopyOption.REPLACE_EXISTING);
