...
3. Keystores listed in KEYSTORE_SOURCE_PATHS env are in locations provided in KEYSTORE_DESTINATION_PATHS env. Files listed in KEYSTORE_DESTINATION_PATHS env before application run, still exist with appended .bak extension.
