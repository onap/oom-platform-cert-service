...
func (controller *CMPv2IssuerController) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := klogger.GetLoggerWithValues("cmpv2-issuer-controller", req.NamespacedName)
...
func updateCMPv2IssuerStatusToVerified(statusUpdater *CMPv2IssuerStatusUpdater, ctx context.Context, log klogger.LeveledLogger) error {
...
func handleErrorUpdatingCMPv2IssuerStatus(log klogger.LeveledLogger, err error) {
	log.Error(err, "Failed to update CMPv2Issuer status")
}

func handleErrorLoadingCMPv2Issuer(log klogger.LeveledLogger, err error) {
	log.Error(err, "Failed to retrieve CMPv2Issuer resource")
}

func handleErrorProvisionerInitialization(ctx context.Context, log klogger.LeveledLogger, err error, statusUpdater *CMPv2IssuerStatusUpdater) {
	log.Error(err, "Failed to initialize provisioner")
	statusUpdater.UpdateNoError(ctx, cmpv2api.ConditionFalse, Error, "Failed to initialize provisioner: %v", err)
}

func handleErrorCMPv2IssuerValidation(ctx context.Context, log klogger.LeveledLogger, err error, statusUpdater *CMPv2IssuerStatusUpdater) {
...
func handleErrorInvalidSecret(ctx context.Context, log klogger.LeveledLogger, err error, statusUpdater *CMPv2IssuerStatusUpdater, secretNamespaceName types.NamespacedName) {
